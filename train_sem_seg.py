...
from tools.dataset_shapenet import PartDataset
...
model = PointWiseConvNET(N = 2048, num_clases = num_classes)
if use_cuda:
    model.cuda()

optimizer = optim.SGD(model.parameters(), lr=0.001, momentum = 0.9, weight_decay = 0.96)
