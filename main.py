...
from tools.acfr_dataset import acfr_dataset, get_data_loaders
...
parser.add_argument('--data_dir', default='/home/anshul/inria_thesis/datasets/Acfr/sydney-urban-objects-dataset/objects/', help='path to dataset')
...
data_dir='/home/anshul/inria_thesis/datasets/Acfr/sydney-urban-objects-dataset/objects/'
...
model = PointWiseConvNET(N = 2048, num_clases = 10)
if use_cuda:
    model.cuda()
